...
for pagina in range(maxpage):
    print(pagina+1)
    url = "https://www.vivareal.com.br/venda/rio-grande-do-norte/natal/?pagina="+str(pagina+1)+"#onde=BR-Rio_Grande_do_Norte-NULL-Natal&tipos=apartamento_residencial"
